...
import Data.List         as X ( (\\), intercalate, intersperse, minimumBy, nub, nubBy, groupBy, sort, sortBy, partition, genericLength, genericIndex, isSuffixOf, isPrefixOf, subsequences )
