...
rule_frameUpdate_propagator = "mset-frameUpdate{ExplicitWithFlags}" `namedRule` theRule where
    theRule p = do
...
rule_frameUpdate_decomposition = "mset-frameUpdate{ExplicitWithFlags}" `namedRule` theRule where
    theRule p = do
