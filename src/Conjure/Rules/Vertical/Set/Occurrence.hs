...
rule_frameUpdate_propagator = "set-frameUpdate{Occurrence}" `namedRule` theRule where
    theRule p = do
...
rule_frameUpdate_decomposition = "set-frameUpdate{Occurrence}" `namedRule` theRule where
    theRule p = do
