...
newtype InfoType = UnclassifiedInfo Text deriving (Show, Eq, Ord)
...
validateStatement (DominanceRelationStatement _lt exp) = do
  ex <- validateExpression exp
  return [DominanceStmt $ Dominance (untype ex) Nothing False]
