...
mkOp op xs =
    case textToLexeme op of
        ...
        Just l -> case l of
            ...
            L_together     -> inject $ MkOpTogether     $ OpTogether     (atNote "together 1" xs 0) (atNote "together 2" xs 1)
            L_apart        -> inject $ MkOpApart        $ OpApart        (atNote "apart 1"    xs 0) (atNote "apart 2"    xs 1)
            L_party        -> inject $ MkOpParty        $ OpParty        (atNote "party 1"    xs 0) (atNote "party 2"    xs 1)
