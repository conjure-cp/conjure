...
funAttrs = mapFrom [sizeyAttrs,jectivityAttrs]
...
partitionAttrs = mapFrom [sizeyAttrs,partSizeAttrs,regularity]
...
allAttributLexemes = concatMap (map fst) [sizeyAttrs , jectivityAttrs , binRelAttrs]
