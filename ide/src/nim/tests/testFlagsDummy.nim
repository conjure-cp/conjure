...
let eprimePath = "../test/testData/sets/recursive/flagsDummy/model000001.eprime"
let minionPath = "../test/testData/sets/recursive/flagsDummy/model000001.eprime-minion"
let dbPath =     "../test/testData/sets/recursive/flagsDummy/test.db"
