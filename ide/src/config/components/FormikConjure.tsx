...
const positiveInt = Yup.number().positive().integer().moreThan(0)
            ...
            <div className="col" key={index}>
                ...
                >
                    <Field
                        ...
                        label="Model"
                        options={props.essenceFiles.map(file => { return { val: file, text: file } })}
                    />
                    ...
                    <Field
                        ...
                        component={SelectWithLabel}
                        label="Param"
                        options={props.paramFiles.map(file => { return { val: file, text: file } })}
                    />
                        ...
                        <Field
                            ...
                            options={
                                [
                                    ...
                                    { val: "-reduce-domains-extend", text: "Reduce Domains Extend" },
                                    ...
                                    { val: "-remove-redundant-vars", text: "Remove Redundant Vars" },
        ...
        <Formik
            ...
            render={({ values }) => (
                <Form >
                    ...
                    <button type="submit" className="btn btn-primary btn-lg btn-block">Solve</button>
                </Form >
            )
            }
        >
