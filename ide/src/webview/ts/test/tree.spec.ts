...
describe("Test the Tree class", function() {
  ...
  describe("Fill circle", function() {
    it("Should set the class of nodes with others that are on failed branches to hasmore red", function() {
      let parent = new Node(0, "simple", "pretty", null, 3, true, 2, false);
      let failedChildThatHasMoreNodes = new Node(
        1,
        "s",
        "p",
        parent,
      ...
      Tree.fillCircle(failedChildThatHasMoreNodes);
  ...
  describe("Fill circle", function() {
    it("Should set the class of nodes with others that are on sol branches to hasmore", function() {
      let parent = new Node(0, "simple", "pretty", null, 3, true, 2, false);
      let childThatHasMoreNodes = new Node(
        1,
        "s",
        "p",
        parent,
      ...
      Tree.fillCircle(childThatHasMoreNodes);
      // console.log($("#node1 circle").attr("class"));
  ...
  describe("appendNodeGroup ", function() {
    it("Should append a <g> for each node in the tree ", function() {
      ...
      let domObjects = svg.selectAll("g.node").data(nodeList, (node: Node) => {
        return node.id;
      });
