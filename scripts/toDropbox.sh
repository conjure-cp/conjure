...
zip -r ~/Dropbox/Public/conjure-wd.zip conjure-wd/problem-specs
zip -r ~/Dropbox/Public/conjure-wd.zip conjure-wd/rules
...
zip -r ~/Dropbox/Public/conjure-wd.zip conjure-wd/test
zip -r ~/Dropbox/Public/conjure-wd.zip conjure-wd/testdata
